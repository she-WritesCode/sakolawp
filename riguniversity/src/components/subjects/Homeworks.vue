    ...
    <DataTable :value="subjects" tableStyle="min-width: 10rem" paginator :rows="10"
        ...
        <template #header>
            <div class="flex flex-wrap items-center justify-between gap-2">
                <div>
                    <InputText v-model="search" placeholder="Search Homeworks" class="pl-10 font-normal" />
                </div>
                <div class="">
        ...
        <Column field="name" header="Deadline"></Column>
        ...
        <Column header="">
            <template #body="slotProps">
                <div class="flex gap-2">
                    <!-- <Button size="small" @click="goToViewSubject(slotProps.data.subject_id)" label="View"></Button>
