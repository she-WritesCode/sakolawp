...
if ($user_active == 1) {
	if (is_page('myaccount') || $wp->request === "myaccount") {
		...
		return $new_template;
	} elseif ($wp->request === "jadwal/create") {
		$new_template =  SAKOLAWP_PLUGIN_DIR . '/templates/student/buat-jadwal.php';
		return $new_template;
	} elseif ($wp->request === "homework") {
		$new_template =  SAKOLAWP_PLUGIN_DIR . '/templates/student/homework.php';
		return $new_template;
		...
		$new_template =  SAKOLAWP_PLUGIN_DIR . '/templates/student/peer_review_room.php';
		return $new_template;
