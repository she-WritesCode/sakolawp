...
<div class="news-page skwp-content-inner skwp-clearfix">
	...
	<div class="text-center">	
		<a class="btn btn-rounded btn-lg btn-success skwp-form-btn skwp-btn" href="<?php echo add_query_arg( 'exam_code', $exam_code, home_url( 'exam' ) );?>"><?php esc_html_e('Start Exam', 'sakolawp'); ?></a>
	</div>
