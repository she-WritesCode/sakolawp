						...
						?>
							...
							<tr>
								...
								<td class="simak-onlinee">
									...
									<?php endif; ?>
									<?php if ($terjawab != 'answered' && $query > 0 && $dbstart1 >= $dbstart && $dbstart1 < $dbend) : ?><a class="btn btn-rounded btn-sm btn-success skwp-btn" href="<?php echo add_query_arg('exam_code', $row['exam_code'], home_url('examroom')); ?>"><?php esc_html_e('Take Exam', 'sakolawp'); ?></a>
									<?php endif; ?>
									...
									<a class="btn btn-rounded btn-sm btn-primary skwp-btn" href="<?php echo add_query_arg(array('exam_code' => $exam_code, 'student_id' => $student_id), home_url('view_exam_result')); ?>" ><?php esc_html_e('View Result', 'sakolawp'); ?></a>
									<?php endif; ?>
								</td>
							</tr>
						<?php endforeach; ?>
