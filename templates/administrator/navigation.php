...
<div class="skwp-menu-wrap">
	...
	<div class="skwp-menu-item <?php if ($wp->request === "homework" || $wp->request === "homeworkroom" || $wp->request === "homeworkroom_details" || $wp->request === "view_homework_student" || $wp->request === "homeworkroom_edit") echo esc_attr('active'); ?>">
		<a href="<?php echo esc_url(home_url('/homework')); ?>">
			<i class="sakolawp-icon sakolawp-icon-shopping-list"></i>
			<?php echo esc_html__('Homework', 'sakolawp'); ?>
		</a>
	</div>
</div>