						...
						<div class="skwp-column skwp-column-3">
							<div class="form-group">
								<select name="year_sel" class="form-control" required="">
									...
									<option value="<?php echo esc_attr($year[0]); ?>" <?php if ($year[0] == $year_sel) echo 'selected'; ?>><?php echo esc_html($year[0]); ?></option>
									<option value="<?php echo esc_attr($year[1]); ?>" <?php if ($year[1] == $year_sel) echo 'selected'; ?>><?php echo esc_html($year[1]); ?></option>
								</select>
							</div>
						</div>
						<div class="skwp-column skwp-column-3">
...
<?php
	...
	echo esc_html_e('You are not assigned to a class yet', 'sakolawp');
endif;
