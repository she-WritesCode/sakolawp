		...
		<div class="ulangan-info skwp-clearfix">
			<div class="skwp-row">
				...
				<div class="info-right info-det skwp-column skwp-column-2">
					<ul>
						<li><span class="title"><?php esc_html_e('Mark', 'sakolawp'); ?></span><span class="isi"><button href="" class="btn btn-primary btn-sm btn-rounded"><?php echo round((($cor/$row['questions']) * 100));?></button></span></li>
				...
				<div class="skwp-row">
					<div class="skwp-column skwp-column-2">
						<div class="nilai-ulangan">
							<h1 class="nilai"><?php echo round((($cor/$row['questions']) * 100));?></h1>
