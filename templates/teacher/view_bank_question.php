...
<div class="view-questions skwp-content-inner skwp-clearfix">
	...
	<div class="skwp-question">
		<?php echo wp_specialchars_decode($row1['question']); ?>
	</div>
		...
		<div class="skwp-row">
			...
			<div class="skwp-column skwp-column-3">
				...
				<select class="skwp-form-control" disabled name="kelas">
					...
					?>
					<option value="<?php echo $class->class_id;?>" <?php if($class->class_id == $row1['class_id']){echo "selected";} ?>><?php echo esc_html( $class->name ); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			<div class="skwp-column skwp-column-3">
				...
				foreach($subjects as $subject):
					?>
					<option value="<?php echo $subject->subject_id;?>" <?php if($subject->subject_id == $row1['subject_id']){echo "selected";} ?>><?php echo $subject->name;?></option>
				<?php endforeach; ?>
				</select>
			</div>
		</div>
