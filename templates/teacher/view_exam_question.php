...
<div class="view-questions skwp-content-inner">
	<div class="skwp-page-title skwp-clearfix">
		...
		<div class="back skwp-back hidden-sm-down pull-right">
			<a href="<?php echo add_query_arg( array('exam_code' => $exam_code), home_url( 'exam_questions' ) );?>"><i class="sakolawp-icon sakolawp-icon-arrow"></i><?php esc_html_e('Back', 'sakolawp'); ?></a>
		</div>
	</div>
