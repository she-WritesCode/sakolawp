...
<div class="attendance-page skwp-content-inner">
	...
	<form action="" id="myForm" name="save_student_attendance_status2" method="POST" class="skwp-clearfix">
		<div class="skwp-row skwp-clearfix">
			...
			<div class="skwp-column skwp-column-4">
				<div class="skwp-form-group"> <label for=""><?php echo esc_html__('Parent Group', 'sakolawp'); ?></label>
							...
							<td nowrap>
								<div class="skwp-form-check">
									<label class="skwp-form-check-label p" for="p-<?php echo esc_attr($no); ?>">
										<input checked class="skwp-form-check-input" <?php if ($row['status'] == 1) echo 'checked'; ?> name="status_<?php echo $row['attendance_id']; ?>" id="p-<?php echo esc_attr($no); ?>" type="radio" value="1">
										<span><?php echo esc_html__('Present', 'sakolawp'); ?></span>
										<span class="background"></span>
									</label>
									<label class="skwp-form-check-label l" for="l-<?php echo esc_attr($no); ?>">
										<input class="skwp-form-check-input" <?php if ($row['status'] == 3) echo 'checked'; ?> name="status_<?php echo $row['attendance_id']; ?>" id="l-<?php echo esc_attr($no); ?>" type="radio" value="3">
										<span><?php echo esc_html__('Late', 'sakolawp'); ?></span>
										<span class="background"></span>
									</label>
									<label class="skwp-form-check-label a" for="a-<?php echo esc_attr($no); ?>">
										<input class="skwp-form-check-input" <?php if ($row['status'] == 2) echo 'checked'; ?> name="status_<?php echo $row['attendance_id']; ?>" id="a-<?php echo esc_attr($no); ?>" type="radio" value="2">
										<span><?php echo esc_html__('Absent', 'sakolawp'); ?></span>
										<span class="background"></span>
									</label>
									<label class="skwp-form-check-label s" for="s-<?php echo esc_attr($no); ?>">
										<input class="skwp-form-check-input" <?php if ($row['status'] == 4) echo 'checked'; ?> name="status_<?php echo $row['attendance_id']; ?>" id="s-<?php echo esc_attr($no); ?>" type="radio" value="4">
										<span><?php echo esc_html__('Sick', 'sakolawp'); ?></span>
										<span class="background"></span>
									</label>
									<label class="skwp-form-check-label i" for="i-<?php echo esc_attr($no); ?>">
										<input class="skwp-form-check-input" <?php if ($row['status'] == 5) echo 'checked'; ?> name="status_<?php echo $row['attendance_id']; ?>" id="i-<?php echo esc_attr($no); ?>" type="radio" value="5">
