										...
										<tr>
											...
											<td class="text-center">
												<a href="<?php echo add_query_arg(array(
																...
																'exam_code' => $exam_code
															), home_url('view_exam_question')); ?>" class="btn btn-rounded btn-sm btn-success skwp-btn"><?php esc_html_e('View', 'sakolawp'); ?></a>
											</td>
											<td class="text-center"><a class="btn btn-rounded btn-sm btn-danger skwp-btn" onClick="return confirm('Confirm Delete?')" href="<?php echo add_query_arg(array('exam_code' => $exam_code, 'question_id' => $row1['question_id'], 'action' => 'delete'), home_url('exam_questions')); ?>">
