				...
				?>
					...
					<tr>
						...
						<td class="skwp-table-actions">
							<a class="btn btn-warning btn-rounded btn-sm skwp-btn" href="<?php echo add_query_arg( 'question_code', $row['question_code'], home_url( 'edit_bank_question' ) );?>">
								<?php echo esc_html__('Edit', 'sakolawp'); ?>
							</a>
							<a class="btn btn-primary btn-rounded btn-sm skwp-btn" href="<?php echo add_query_arg( 'question_code', $row['question_code'], home_url( 'view_bank_question' ) );?>">
								<?php echo esc_html__('View', 'sakolawp'); ?>
							</a>
							<a class="btn btn-danger btn-rounded btn-sm skwp-btn" onClick="return confirm('<?php echo esc_html__('Confirm Delete ?', 'sakolawp'); ?>')" href="<?php echo add_query_arg( array('action' => 'delete', 'question_code' => $row['question_code']), home_url( 'questions_bank' ) );?>">
