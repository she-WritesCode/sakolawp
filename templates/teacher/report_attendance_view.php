...
<div class="attendance-page skwp-content-inner">
	...
	<form id="myForm" name="save_student_attendance" action="" method="POST">
		<div class="skwp-clearfix skwp-row">
			...
			<div class="skwp-column skwp-column-5">
				<div class="form-group"> <label class="gi" for=""><?php echo esc_html__('Parent Group', 'sakolawp'); ?></label>
					<input type="text" class="form-control" required disabled value="<?php echo $section_teached->name; ?>">
					<input type="hidden" class="form-control" name="section_id" required value="<?php echo $section_teached->section_id; ?>">
				</div>
			</div>
			<div class="skwp-column skwp-column-5">
			...
			<div class="skwp-column skwp-column-5">
				<div class="form-group">
					...
					<select name="year_sel" class="form-control" required="">
						...
						<option value="<?php echo $year[0]; ?>" <?php if ($year_sel == $year[0]) echo 'selected'; ?>><?php echo $year[0]; ?></option>
						<option value="<?php echo $year[1]; ?>" <?php if ($year_sel == $year[1]) echo 'selected'; ?>><?php echo $year[1]; ?></option>
					</select>
				</div>
			</div>
			<div class="skwp-column skwp-column-5">
