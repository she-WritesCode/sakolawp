			...
			<div class="table-responsive">
				<table class="table table-lightbor table-lightfont">
					...
					<tr>
						...
						<td>
							<a class="skwp-btn btn-rounded btn-sm btn-primary text-putih"><?php echo $row['pass'];?>%</a>
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						...
						<td>
							<a class="skwp-btn btn-rounded btn-sm btn-success text-putih"><?php echo $row['duration'];?> <?php echo esc_html__( 'Minutes', 'sakolawp' ); ?></a>
						</td>
					</tr>
				</table>
			</div>
...
<?php 
	...
	<div style="margin-bottom:15px;text-align:right;"><button class="skwp-btn btn-primary btn-rounded btn-upper" data-target="#exampleModal1" data-toggle="modal" type="button">Add Exam</button></div>
	<?php
endif;
