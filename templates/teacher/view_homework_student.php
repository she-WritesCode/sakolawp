					...
					<div class="teacher-comment">
						<form id="myForm" name="save_marks_homework" action="" method="POST">
							...
							<div class="add-mark">
								...
								<input type="number" name="mark" min="1" max="100" maxlength="3" required value="<?php echo esc_attr(isset($row['mark']) ? $row['mark'] : $total_mark / count($peer_reviews)); ?>" <?php echo (isset($row['mark']) ? "" : "hidden"); ?>>
