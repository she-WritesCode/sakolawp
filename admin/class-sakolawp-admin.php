...
class Sakolawp_Admin {
						...
						<form id="myForm" name="myform" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="POST">
							...
							<div class="modal-body">
								<div class="form-group skwp-row">
									...
									<div class="skwp-column skwp-column-2of3">
										<div class="input-group">
											<input class="skwp-form-control" placeholder="<?php esc_html_e('Section Name', 'sakolawp'); ?>" name="name" required="" type="text" value="<?php echo esc_attr($section->name) ?>">
										</div>
									</div>
								</div>
								<div class="form-group skwp-row">
									...
									<div class="skwp-column skwp-column-3">
										<div class="input-group">
											<select name="time_start_min" class="skwp-form-control" required>
												...
												<?php for($i = 0; $i <= 11 ; $i++):?>
												<option value="<?php $n = $i * 5; if($n < 10) echo '0'.$n; else echo esc_attr( $n );?>" <?php if (($i * 5) == $time_start_min) echo esc_attr( 'selected' );?>><?php $n = $i * 5; if($n < 10) echo '0'.$n; else echo esc_html( $n );?></option>
												<?php endfor;?>
											</select>
										</div>
									</div>
									...
									<div class="skwp-column skwp-column-3">
										<div class="input-group">
											<select name="time_end_min" class="skwp-form-control" required>
												<option value=""><?php echo esc_html__('Minutes', 'sakolawp'); ?></option>
												<?php for($i = 0; $i <= 11 ; $i++):?>
												<option value="<?php $n = $i * 5; if($n < 10) echo '0'.$n; else echo esc_attr( $n ); ?>" <?php if (($i * 5) == $time_end_min) echo esc_attr( 'selected' ); ?>><?php $n = $i * 5; if($n < 10) echo '0'.$n; else echo esc_html( $n );?></option>
												<?php endfor;?>
											</select>
										</div>
									</div>
	...
	function sakolawp_select_section_first_f() {
		...
		foreach ($sections as $row) 
		{ ?>
			<option value="<?php echo esc_attr( $row['section_id'] ) ?>" <?php if ($row['section_id'] == $section_id[0]['section_id']) {echo esc_attr( "selected" ); } ?>><?php echo esc_html( $row['name'] ); ?></option>
		<?php }
	}
