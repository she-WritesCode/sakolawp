...
class Sakolawp_Admin
{
	...
	public function enqueue_styles()
	{
		...
		wp_enqueue_style('rig-university', plugin_dir_url(__FILE__) . '../public/css/index.css', array(), $this->version, 'all');
	}
	...
	public function addPluginAdminMenu()
	{
		...
		if (($sakola_lb_verify_res['status'])) {
			...
			add_submenu_page($this->plugin_name . '-settings', esc_html__('Programs', 'sakolawp'), esc_html__('Programs', 'sakolawp'), 'administrator', $this->plugin_name . '-manage-class', array($this, 'manageClassAdminSettings'), 3);
									...
									<div class="form-group skwp-row">
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<input class="skwp-form-control" placeholder="<?php esc_html_e('Semester', 'sakolawp'); ?>" name="name" required="" type="text" value="<?php echo esc_attr($exam['name']); ?>">
											</div>
										</div>
									</div>
									<div class="form-group skwp-row">
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<select class="skwp-form-control" name="start">
													<option value="1" <?php if ($exam['start_exam'] == 1) {
																			echo "selected";
																		} ?>><?php esc_html_e('January', 'sakolawp'); ?></option>
													<option value="2" <?php if ($exam['start_exam'] == 2) {
																			echo "selected";
																		} ?>><?php esc_html_e('February', 'sakolawp'); ?></option>
													<option value="3" <?php if ($exam['start_exam'] == 3) {
																			echo "selected";
																		} ?>><?php esc_html_e('March', 'sakolawp'); ?></option>
													<option value="4" <?php if ($exam['start_exam'] == 4) {
																			echo "selected";
																		} ?>><?php esc_html_e('April', 'sakolawp'); ?></option>
													<option value="5" <?php if ($exam['start_exam'] == 5) {
																			echo "selected";
																		} ?>><?php esc_html_e('May', 'sakolawp'); ?></option>
													<option value="6" <?php if ($exam['start_exam'] == 6) {
																			echo "selected";
																		} ?>><?php esc_html_e('June', 'sakolawp'); ?></option>
													<option value="7" <?php if ($exam['start_exam'] == 7) {
																			echo "selected";
																		} ?>><?php esc_html_e('July', 'sakolawp'); ?></option>
													<option value="8" <?php if ($exam['start_exam'] == 8) {
																			echo "selected";
																		} ?>><?php esc_html_e('August', 'sakolawp'); ?></option>
													<option value="9" <?php if ($exam['start_exam'] == 9) {
																			echo "selected";
																		} ?>><?php esc_html_e('September', 'sakolawp'); ?></option>
													<option value="10" <?php if ($exam['start_exam'] == 10) {
																			echo "selected";
																		} ?>><?php esc_html_e('October', 'sakolawp'); ?></option>
													<option value="11" <?php if ($exam['start_exam'] == 11) {
																			echo "selected";
																		} ?>><?php esc_html_e('November', 'sakolawp'); ?></option>
													<option value="12" <?php if ($exam['start_exam'] == 12) {
																			echo "selected";
																		} ?>><?php esc_html_e('December', 'sakolawp'); ?></option>
												</select>
											</div>
										</div>
									</div>
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<select class="skwp-form-control" name="end">
													<option value="1" <?php if ($exam['end_exam'] == 1) {
																			echo "selected";
																		} ?>><?php esc_html_e('January', 'sakolawp'); ?></option>
													<option value="2" <?php if ($exam['end_exam'] == 2) {
																			echo "selected";
																		} ?>><?php esc_html_e('February', 'sakolawp'); ?></option>
													<option value="3" <?php if ($exam['end_exam'] == 3) {
																			echo "selected";
																		} ?>><?php esc_html_e('March', 'sakolawp'); ?></option>
													<option value="4" <?php if ($exam['end_exam'] == 4) {
																			echo "selected";
																		} ?>><?php esc_html_e('April', 'sakolawp'); ?></option>
													<option value="5" <?php if ($exam['end_exam'] == 5) {
																			echo "selected";
																		} ?>><?php esc_html_e('May', 'sakolawp'); ?></option>
													<option value="6" <?php if ($exam['end_exam'] == 6) {
																			echo "selected";
																		} ?>><?php esc_html_e('June', 'sakolawp'); ?></option>
													<option value="7" <?php if ($exam['end_exam'] == 7) {
																			echo "selected";
																		} ?>><?php esc_html_e('July', 'sakolawp'); ?></option>
													<option value="8" <?php if ($exam['end_exam'] == 8) {
																			echo "selected";
																		} ?>><?php esc_html_e('August', 'sakolawp'); ?></option>
													<option value="9" <?php if ($exam['end_exam'] == 9) {
																			echo "selected";
																		} ?>><?php esc_html_e('September', 'sakolawp'); ?></option>
													<option value="10" <?php if ($exam['end_exam'] == 10) {
																			echo "selected";
																		} ?>><?php esc_html_e('October', 'sakolawp'); ?></option>
													<option value="11" <?php if ($exam['end_exam'] == 11) {
																			echo "selected";
																		} ?>><?php esc_html_e('November', 'sakolawp'); ?></option>
													<option value="12" <?php if ($exam['end_exam'] == 12) {
																			echo "selected";
																		} ?>><?php esc_html_e('December', 'sakolawp'); ?></option>
												</select>
											</div>
						...
						<form id="myForm" name="myform" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
							...
							<div class="modal-body">
								<div class="form-group skwp-row">
									...
									<div class="skwp-column skwp-column-2of3">
										<div class="input-group">
											<input class="skwp-form-control" placeholder="<?php esc_html_e('Semester', 'sakolawp'); ?>" name="name" required="" type="text">
										</div>
									</div>
								</div>
								<div class="form-group skwp-row">
	...
	public function displayPluginAdminSettings2()
	{
							...
							<form id="myForm" name="myform" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
								...
								<div class="modal-body">
									<div class="form-group skwp-row">
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<input class="skwp-form-control" placeholder="<?php esc_html_e('Class Name', 'sakolawp'); ?>" name="name" required="" type="text" value="<?php echo esc_attr($class->name); ?>">
											</div>
										</div>
									</div>
								</div>
					...
					<div class="modal-content">
						...
						?>
							<form id="myForm" name="myform" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
								...
								<div class="modal-body">
									<div class="form-group skwp-row">
										<label class="skwp-column skwp-column-3 col-form-label" for=""> <?php esc_html_e('Parent Group Name', 'sakolawp'); ?></label>
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<input class="skwp-form-control" placeholder="<?php esc_html_e('Parent Group Name', 'sakolawp'); ?>" name="name" required="" type="text" value="<?php echo esc_attr($section->name) ?>">
											</div>
										</div>
									</div>
									<div class="form-group skwp-row">
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<select class="skwp-form-control" name="class_id">
													...
													foreach ($classes as $class) :
													?>
														<option value="<?php echo esc_attr($class->class_id); ?>" <?php if ($class->class_id == $section->class_id) {
																														echo "selected";
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<select class="skwp-form-control" name="teacher_id">
													...
													?>
														<option value="<?php echo esc_attr($teacher->ID); ?>" <?php if ($teacher->ID == $section->teacher_id) {
																													echo "selected";
							...
							<form id="myForm" name="myform" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
								...
								<div class="modal-body">
									<div class="form-group skwp-row">
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<input class="skwp-form-control" placeholder="<?php esc_html_e('Subject Name', 'sakolawp'); ?>" name="name" required="" type="text" value="<?php echo esc_attr($subject->name) ?>">
											</div>
										</div>
									</div>
									<div class="form-group skwp-row">
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<select class="skwp-form-control first" name="class_id" id="class_holder">
													...
													foreach ($classes as $class) :
													?>
														<option value="<?php echo esc_attr($class->class_id); ?>" <?php if ($class->class_id == $subject->class_id) {
																														echo "selected";
																													} ?>><?php echo esc_html($class->name); ?></option>
													<?php endforeach; ?>
												</select>
									...
									<div class="form-group skwp-row">
										<label class="col-form-label skwp-column skwp-column-3" for=""> <?php esc_html_e('Parent Group', 'sakolawp'); ?></label>
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
										...
										<div class="skwp-column skwp-column-2of3">
											<div class="input-group">
												<select class="skwp-form-control" name="teacher_id">
													...
													foreach ($teachers as $teacher) :
													?>
														<option value="<?php echo esc_attr($teacher->ID); ?>" <?php if ($teacher->ID == $subject->teacher_id) {
																													echo "selected";
																												} ?>><?php echo esc_html($teacher->display_name); ?></option>
													<?php endforeach; ?>
												</select>
										...
										<div class="skwp-column skwp-column-1">
											...
											<div class="input-group">
												...
												<select class="skwp-form-control" name="subject_id" disabled>
													...
													foreach ($sub as $row4) : ?>
														<option value="<?php echo esc_attr($row4['subject_id']); ?>" <?php if ($routine['subject_id'] == $row4['subject_id']) echo 'selected'; ?>><?php echo esc_html($row4['name']); ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
												...
												<select name="time_start_min" class="skwp-form-control" required>
													...
													<?php for ($i = 0; $i <= 11; $i++) : ?>
														<option value="<?php $n = $i * 5;
																		if ($n < 10) echo '0' . $n;
																		else echo esc_attr($n); ?>" <?php if (($i * 5) == $time_start_min) echo esc_attr('selected'); ?>><?php $n = $i * 5;
																																											if ($n < 10) echo '0' . $n;
										...
										<div class="skwp-column skwp-column-3">
											...
											<div class="input-group">
												...
												<select name="time_end" class="skwp-form-control" required>
													<option value=""><?php echo esc_html__('hour', 'sakolawp'); ?></option>
													<?php for ($i = 0; $i <= 12; $i++) : ?>
														<option value="<?php echo esc_attr($i); ?>" <?php if ($i == $time_end) echo esc_attr("selected"); ?>><?php echo esc_html($i); ?></option>
													<?php endfor; ?>
												</select>
											</div>
										</div>
											...
											<div class="input-group">
												<select name="time_end_min" class="skwp-form-control" required>
													...
													<?php for ($i = 0; $i <= 11; $i++) : ?>
														<option value="<?php $n = $i * 5;
																		if ($n < 10) echo '0' . $n;
																		else echo esc_attr($n); ?>" <?php if (($i * 5) == $time_end_min) echo esc_attr('selected'); ?>><?php $n = $i * 5;
																																										if ($n < 10) echo '0' . $n;
																																										else echo esc_html($n); ?></option>
													<?php endfor; ?>
												</select>
	...
	public function homeworkAdminSettings()
	{
		...
		if (isset($_GET['read'])) {
			...
			if (!empty($homework_code)) {
				global $wpdb;
				$homeworks = $wpdb->get_row("SELECT homework_code, homework_reply, file_name FROM {$wpdb->prefix}sakolawp_deliveries WHERE homework_code = '$homework_code' AND student_id = '$student_id'", ARRAY_A); ?>
				<div class="modal fade show" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: block;">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="student-homework-ans skwp-clearfix">
								<?php
								$tugas_ada = $homeworks;
								if (count($homeworks) > 0) : ?>
									<h4 class="homework-detail-title">
			...
			case 'input':
				...
				if ($args['subtype'] != 'checkbox') {
					...
					if (isset($args['disabled'])) {
						...
						echo wp_specialchars_decode($prependStart) . '<input type="' . $args['subtype'] . '" id="' . $args['id'] . '_disabled" ' . $step . ' ' . $max . ' ' . $min . ' name="' . $args['name'] . '_disabled" size="40" disabled value="' . esc_attr($value) . '" /><input type="hidden" id="' . $args['id'] . '" ' . $step . ' ' . $max . ' ' . $min . ' name="' . $args['name'] . '" size="40" value="' . esc_attr($value) . '" />' . $prependEnd;
					} else {
						echo wp_specialchars_decode($prependStart) . '<input type="' . $args['subtype'] . '" id="' . $args['id'] . '" "' . $args['required'] . '" ' . $step . ' ' . $max . ' ' . $min . ' name="' . $args['name'] . '" size="40" value="' . esc_attr($value) . '" />' . $prependEnd;
					}
				} else {
...
<?php }
	...
	/* SakolaWP Licensebox */
	public function sakolawp_licensebox_plugin_page()
	{
		// set this var to be used in the settings-display view
		require_once 'partials/' . $this->plugin_name . '-license.php';
	}
}
