					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a class="btn skwp-btn btn-sm btn-primary" href="<?php echo add_query_arg(array('edit' => $exam['exam_id']), admin_url('admin.php?page=sakolawp-settings')); ?>">
										<i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i>
										<?php esc_html_e('Edit', 'sakolawp'); ?>
									</a>
									<a class="btn skwp-btn btn-sm btn-danger" href="<?php echo add_query_arg(array('delete' => $exam['exam_id']), admin_url('admin.php?page=sakolawp-settings')); ?>">
										<i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i>
