						...
						?>
							<tr>
								...
								<td class="skwp-row-actions">
									<a class="btn skwp-btn btn-sm btn-success" href="<?php echo add_query_arg(array('exam_code' => $row['exam_code'], 'action' => 'exam_room'), admin_url('admin.php?page=sakolawp-exam')); ?>">
				...
				<ul class="nav nav-tabs upper">
					<li class="nav-item">
						<a class="nav-link <?php if ($action == 'exam_room') {
												echo 'active';
											} ?>" href="<?php echo add_query_arg(array('exam_code' => $exam_code, 'action' => 'exam_room'), admin_url('admin.php?page=sakolawp-exam')); ?>"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo esc_html__('Exam Detail', 'sakolawp'); ?></span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link <?php if ($action == 'exam_questions') {
												echo 'active';
											} ?>" href="<?php echo add_query_arg(array('exam_code' => $exam_code, 'action' => 'exam_questions'), admin_url('admin.php?page=sakolawp-exam')); ?>"><i class="os-icon picons-thin-icon-thin-0067_line_thumb_view"></i><span><?php echo esc_html__('Questions', 'sakolawp'); ?></span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link <?php if ($action == 'exam_results') {
												echo 'active';
											} ?>" href="<?php echo add_query_arg(array('exam_code' => $exam_code, 'action' => 'exam_results'), admin_url('admin.php?page=sakolawp-exam')); ?>"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo esc_html__('Exam Result', 'sakolawp'); ?></span></a>
					</li>
				</ul>
			</div>
											...
											<tr>
												...
												<td>
													<?php if (!empty($row1['question_excerpt'])) {
														...
														echo wp_specialchars_decode($row1['question']);
													} ?>
												</td>
