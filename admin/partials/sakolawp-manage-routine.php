														...
														<div class="pi-controls" style="text-align:right;">
															<div class="pi-settings os-dropdown-trigger">
																...
																<div class="os-dropdown">
																	...
																	<ul>
																		<li>
																			<a class="btn danger skwp-btn btn-rounded btn-warning" href="<?php echo add_query_arg(array('edit' => $row2['class_routine_id']), admin_url('admin.php?page=sakolawp-manage-routine')); ?>"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php esc_html_e('Edit', 'sakolawp'); ?></span></a>
																		</li>
																		<li>
																			<a class="btn skwp-btn btn-rounded btn-danger" href="<?php echo add_query_arg(array('delete' => $row2['class_routine_id']), admin_url('admin.php?page=sakolawp-manage-routine')); ?>"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php esc_html_e('Delete', 'sakolawp'); ?></span></a>
																		</li>
																	</ul>
																</div>
															</div>
